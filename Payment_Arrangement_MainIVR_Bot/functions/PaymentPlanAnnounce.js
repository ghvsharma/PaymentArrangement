...
exports.handler =async function(context, event, callback) {
 console.log('PaymentPlanAnnounce');
  ...
  {  
    ...
    SetLegalDates=dateFormat(DT, "yyyy-mmmm-d");
  ...
  {
    console.log("NP = 0");
    LegalSay= "Your payment of $"+FP+" will be made on "+start_date;
    Say=LegalSay;
  }
  else if (NP==1)
  {
    ...
    if(Number(FP)== 0)
      ...
      Amt=FP;
    console.log("NP = 1");
    LegalSay= "Your payment plan is to pay $"+Amt+" on "+start_date+" and next payment of $"+InstallmentPayment+" on "+InstallmentStart_Date;
    Say=LegalSay; 
  ...
  else if(Number(NP>=2))
  {
   if(Number(FP)==0)
   {
    LegalSay="Your payment plan is to pay $"+InstallmentPayment+" on "+start_date+" "+LegalPC;
    Say= "Your payment plan is to pay $"+InstallmentPayment+" starting "+start_date+" in "+NP+" "+Frequency+" payments. ";  
    console.log(LegalSay);
   }
   else
   {
      LegalSay="Your payment plan is to pay $"+FP+" starting "+start_date+" and $"+InstallmentPayment+" "+LegalPC;
      Say= "Your payment plan is to pay $"+FP+" starting "+start_date+" and Subsequent "+(NP)+" "+Frequency+" payments of $"+InstallmentPayment+"."; 
      console.log(LegalSay);
   }
  }
